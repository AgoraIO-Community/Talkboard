  ...
  */
    ...
    */
    ...
    /** 18: The request to leave the channel is rejected.
     ...
     - When the user has left the channel and still calls IRtcEngine::leaveChannel to leave the channel. In this case, please stop calling IRtcEngine::leaveChannel.
     - When the user has not joined the channel and and still calls IRtcEngine::leaveChannel to leave the channel. In this case, no extra operation is needed.
     */
    ...
    /** 113: The user is not in the channel when calling the agora::rtc::IRtcEngine::sendStreamMessage method.
     */
    ERR_NOT_IN_CHANNEL = 113,
    /** 114: The size of the sent data is over 1024 bytes when the user calls the agora::rtc::IRtcEngine::sendStreamMessage method.
     */
    ERR_SIZE_TOO_LARGE = 114,
    /** 115: The bitrate of the sent data exceeds the limit of 6 Kbps when the user calls the agora::rtc::IRtcEngine::sendStreamMessage method.
     */
    ERR_BITRATE_LIMIT = 115,
    /** 116: Too many data streams (over 5 streams) are created when the user calls the agora::rtc::IRtcEngine::createDataStream method.
     */
    ...
    /** 130: Encryption is enabled when the user calls the agora::rtc::IRtcEngine::addPublishStreamUrl method (CDN live streaming does not support encrypted streams).
     */
