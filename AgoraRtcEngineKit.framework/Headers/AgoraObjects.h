 ...
 */
@property (assign, nonatomic) NSUInteger uid;
/** The volume of the speaker ranging from 0 (lowest volume) to 255 (highest volume).
 */
...
- Communication mode: The number of all users in the channel.
- Live broadcast mode:
...
/** The video frame dimension used to specify the video quality and measured by the total number of pixels along a frame's width and height.
...
You can customize the dimension, or select from the following list:
 ...
 - The value of the dimension does not specify the orientation mode of the output ratio. For how to set the video orientation, see [AgoraVideoOutputOrientationMode](AgoraVideoOutputOrientationMode).
 - Whether 720p can be supported depends on the device. If the device cannot support 720p, the frame rate will be lower than the one listed in the table. Agora optimizes the video in lower-end devices. Contact [support@agora.io](mailto:support@agora.io) for special requirements.
 */
...
/** Bitrate of the video:
 ...
 Refer to the table below and set your desired bitrate. If the bitrate you set is beyond the proper range, the SDK will automatically adjust it to a value within the range. You can also choose from the following options:

 - AgoraVideoBitrateStandard: (Recommended) The standard bitrate mode. In this mode, the bitrate under the live broadcast and communication profile differs:
 ...
 - AgoraVideoBitrateCompatible: The compatible bitrate mode. In this mode, the bitrate stays the same regardless of the channel profile. In a live broadcast channel, if you choose this mode, the video frame rate may be lower than the set value.

Agora uses different video codecs for different channel profiles to optimize the user experience. For example, a communication channel prioritizes the smoothness while a live broadcast channel emphasizes on the video quality (a higher bitrate requirement for a live broadcast channel). Therefore, Agora recommends setting this parameter as AgoraVideoBitrateStandard.
...
The base bitrate in this table applies to a communication channel. A live broadcast channel generally requires a higher bitrate for better video quality. Agora recommends setting the bitrate mode as AgoraVideoBitrateStandard. You can also set the bitrate as twice the base bitrate.
 ...
 * AgoraVideoOutputOrientationModeFixedLandscape(1): The output video is always in landscape mode. If the captured video is in portrait mode, the video encoder crops it to fit the output. This applies to situations where the receiving end cannot process the rotational information. For example, CDN live streaming.
 * AgoraVideoOutputOrientationModeFixedPortrait(2): The output video is always in portrait mode. If the captured video is in landscape mode, the video encoder crops it to fit the output. This applies to situations where the receiving end cannot process the rotational information. For example, CDN live streaming.

For scenarios with video rotation, Agora provides [Basic: Video Rotation Guide](https://docs.agora.io/en/2.3/product/Interactive%20Broadcast/Quickstart%20Guide/rotation_guide_ios) to guide users on how to set this parameter to get the video orientation they want.
...
/** An AgoraLiveTranscodingUser object managing the user layout configuration in the CDN live streaming. Agora supports a maximum of 17 transcoding users in a CDN streaming channel. See AgoraLiveTranscodingUser for details.
 */
...
/** Size of the added stream to the broadcast. The default value is 0; same size as the original stream.
 */
@property (assign, nonatomic) CGSize size;
/** Video GOP of the added stream to the broadcast. The default value is 30 fps.
 */
@property (assign, nonatomic) NSInteger videoGop;
...
/** Audio sampling rate of the added stream to the broadcast. The default value is 48000. See AgoraAudioSampleRateType for details.
 */
@property (assign, nonatomic) AgoraAudioSampleRateType audioSampleRate;
/** Audio bitrate of the added stream to the broadcast. The default value is 48 Kbps.
 */
@property (assign, nonatomic) NSInteger audioBitrate;
/** Number of the audio channels to add into the broadcast within the range of [1,2]. The default value is 1.
 */
@property (assign, nonatomic) NSInteger audioChannels;
...
@property (assign, nonatomic) NSUInteger uid;
/** Horizontal position of the region on the screen ranging between 0.0 and 1.0. */
@property (assign, nonatomic) CGFloat x;
/** Vertical position of the region on the screen ranging between 0.0 and 1.0. */
@property (assign, nonatomic) CGFloat y;
/** Actual width of the region ranging between 0.0 and 1.0. For example, if the width of the screen is 360, and the width of the region is 120, set the width value as 0.33. */
@property (assign, nonatomic) CGFloat width;
/** Actual height of the region ranging between 0.0 and 1.0. For example, if the height of the screen is 240, and the height of the region is 120, set the height value as 0.5. */
@property (assign, nonatomic) CGFloat height;
/** Layer position of the region between 0 and 100:
...
/** Please ignore this property. Setting this property will not take any effect. */
@property (assign, nonatomic) AgoraVideoRenderMode renderMode;
@end
...
Sets the screen display region of a host or a delegated host in CDN live streaming. See AgoraRtcVideoCompositingRegion for details.
 */
...
/** CDN live stream setting

 **DEPRECATED**

 Agora recommends using [setLiveTranscoding]([AgoraRtcEngineKit setLiveTranscoding:]) for CDN live setting.
 */
__deprecated
...
/** Sets whether the current host is the RTMP stream owner.
 ...
 - YES: The current host is the RTMP stream owner and the push-stream configuration is enabled (default).
...
/** Width of the injectded stream. Set it as 0.
 */
@property (assign, nonatomic) NSInteger injectStreamWidth;

/** Height of the injectded stream. Set it as 0.
 */
@property (assign, nonatomic) NSInteger injectStreamHeight;

/** Address of the injectded stream into the channel.
 */
...
/** The push-stream HTTP/HTTPS address of the original stream not requiring picture-blending. The default value is nil.
 */
...
An incorrect timestamp will result in frame loss or unsynchronized audio and video.
...
/** (Optional) Specifies whether to rotate the incoming video group.

Optional values: 0, 90, 180, or 270 clockwise. Set as 0 by default.
 */
 ...
 *    360 &times; 640, often the buffer stride is 368, that is, there extra 8 pixels on the
